...
if ( ! function_exists( 'vc_dev_example_html_template_base_example' ) ) :
    ...
    function vc_dev_example_html_template_base_example() {
        vc_map( [
            ...
            'html_template'           => dirname( __FILE__ ) . '/templates/test_element.php',
            ...
            'params'                  => [
                ...
                [
                    ...
                    'value'       => __( '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo..</p>', 'vc-dev-example' ),
