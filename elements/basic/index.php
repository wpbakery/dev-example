...
add_action('vc_before_init', 'vc_dev_example_custom_box_element');
/**
 ...
 */
function vc_dev_example_custom_box_element() {
    vc_map([
        'name'        => __('Custom Box', 'vc-dev-example'),
        // base should be the same as the shortcode slug.
        'base'        => 'vc_dev_example_custom_box',
        ...
        'params'      => [
            ...
            [
                ...
                'param_name' => 'content',
                'value'      => __('<p>This is some example content. You can customize it using the WPBakery editor.</p>'),
            ],
            [
                'type'       => 'colorpicker',
...
add_shortcode('vc_dev_example_custom_box', 'vc_dev_example_custom_box_shortcode');
/**
 ...
 * @return string
 */
function vc_dev_example_custom_box_shortcode($atts, $content = '') {
    $atts = shortcode_atts([
